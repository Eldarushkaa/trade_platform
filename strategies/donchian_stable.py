"""
Donchian Breakout Bot (Stable) — классическая трендовая система (Turtle Trading), trend-following.
Версия с зафиксированными оптимальными параметрами.
...
Использование:
    ...
    REGISTERED_BOTS = [
        DonchianStableBot.for_symbol("BTCUSDT"),
        DonchianStableBot.for_symbol("ETHUSDT"),
        DonchianStableBot.for_symbol("SOLUSDT"),
    ]
"""
import math
...
class DonchianStableBot(BaseStrategy):
    name_prefix = "donchian_stable"
    name = "donchian_stable_bot"
    symbol = "BTCUSDT"
    ...
    N_PERIOD     = 42       # Breakout lookback (вход)
    M_PERIOD     = 23       # Exit lookback (выход)
